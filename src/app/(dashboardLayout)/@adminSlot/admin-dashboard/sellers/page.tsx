...
export default async function SellerManagement() {
  ...
  const filteredData = data?.filter((user: any) => user.role === Roles.SELLER);
                ...
                >
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gray-100 text-gray-600 font-semibold text-xs flex items-center justify-center border border-gray-200 shadow-sm uppercase">
